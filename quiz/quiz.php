...
<html xmlns="http://www.w3.org/1999/xhtml" style="background-image:22.jpg">

<head>

<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>HTML and CSS Quiz! Jeopardy Template</title>
<meta name="description" content=", What is the symbol for an id?, What is the symbol for a class? , How would you select a paragraph element with class &quot;methodology&quot; inside a div with id &quot;mygraphic&quot;, How do you group selectors?" />
...
.button_example:hover{
 border-top-color: #E04899;border-right-color: #805D2C;border-bottom-color: #E04899;border-left-color: #805D2C;border-width: 8px 7px 8px 7px;border-style: solid;
...
#game h3 {
 ...
 #game thead th {
    ...
    background: linear-gradient(rgba(255, 0, 0, 0), rgba(255, 255, 0, 0));
    ...
    height: 60px;
    font-size: 20px;
    border: 3px solid rgba(255, 255, 95, 0.35);
}
    ...
    background: -o-linear-gradient(red, yellow);
    background: -moz-linear-gradient(red, yellow);
    background: linear-gradient(rgba(56, 53, 53, 0.42), rgba(10, 11, 14, 0.69));
    vertical-align: middle;
    background-color: rgba(42, 54, 152, 0.38);
    padding: 5px;
    text-align: center;
    width: 19%;
    color: #ffff5f;
    height: 60px;
    font-size: 20px;
      box-shadow: 7px 7px 2px 0px rgba(0,0,0,0.2), 0 6px 20px 0px rgba(0,0,0,0.19);
}
...
#stats {
	position:fixed;
	bottom:0;
background-color: rgba(22, 105, 93, 0.95);
	width:100%;
	text-align:center;
	height:110px;
	display:none;
...
#stats input.team-name {
    ...
    background: linear-gradient(to right, rgba(255,0,0,0), #4484a5);
    background-color: #8bd4bb;
    border: none;
    font-size: 18px;
    font-weight: bold;
    text-align: center;
...
#prompt a:link, #prompt a:visited, #prompt a:hover 
	{
    background-color: rgba(76, 175, 111, 0.57);
    border: none;
    color: white;
    padding: 15px 32px;
    text-align: center;
...
<body  style="background-image:url('145.jpg');">

<input id="teams"  value="<?php echo $team; ?>"style="display:none;">
	...
	<tbody>
					...
					<div id="jid">
						<td id="tq00" class="cell clean" onclick="prompt.show('q00', 100)" >
								<h3>100</h3>
										<div class="hide">
									<div id="q00">Two</div>
									<div id="aq00" >How many Tomb Raider movies were made?</div>
								</div>
							</td>
						...
						<td id="tq01" class="cell clean" onclick="prompt.show('q01', 100)">
							...
							<div class="hide">
								<div id="q01">18</div>
								<div id="aq01">How many chapters are in The Bhagavat Gita?</div>
							</div>
						</td>
						...
						<td id="tq02" class="cell clean" onclick="prompt.show('q02', 100)">
							<h3>100</h3>
							<div class="hide">
								<div id="q02">Sri Lanka</div>
								<div id="aq02">Which was the 1st non Test playing country to beat India in an international match?</div>
							</div>
						</td>
						<td id="tq03" class="cell clean" onclick="prompt.show('q03', 100)">
							...
							<div class="hide">
								<div id="q03">1969</div>
								<div id="aq03">In which year first man land on moon?</div>
							</div>
						</td>					
						<td id="tq04" class="cell clean" onclick="prompt.show('q04', 100)">
							<h3>100</h3>
							<div class="hide">
								<div id="q04">Fermi</div>
								<div id="aq04">Nuclear sizes are expressed in a unit named</div>
							</div>
						</td>
			</tr>
			<tr>
				<td id="tq10" class="cell clean" onclick="prompt.show('q10', 200)">
					<h3>200</h3>
					<div class="hide">
						<div id="q10">Sardar Vallabhbhai Patel</div>
						<div id="aq10"> Who was the first person to address Gandhiji as ‘Father of Nation’?</div>
					</div>
				</td>
						...
						<td id="tq11" class="cell clean" onclick="prompt.show('q11', 200)">
							<h3>200</h3>
							<div class="hide">
								<div id="q11">Lewis Carroll</div>
								<div id="aq11">Who wrote the famous book "Alice in Wonderland"?</div>
							</div>
						</td>
						...
						<td id="tq12" class="cell clean" onclick="prompt.show('q12', 200)">
							<h3>200</h3>
							<div class="hide">
								<div id="q12">Wilson Jones</div>
								<div id="aq12">Who was the first Indian to win the World Amateur Billiards title?</div>
							</div>
						</td>
						...
						<td id="tq13" class="cell clean" onclick="prompt.show('q13', 200)">
							...
							<div class="hide">
								<div id="q13">Mars</div>
								<div id="aq13">Which planet is named after the Roman god of war?</div>
							</div>
						</td>
						...
						<td id="tq14" class="cell clean" onclick="prompt.show('q14', 200)">
							<h3>200</h3>
							<div class="hide">
								<div id="q14">Momentum</div>
								<div id="aq14">If two bodies of different masses, initially at rest, are acted upon by the same force for the same time, then the both bodies acquire the same</div>
							</div>
						</td>
			...
			<tr>
						...
						<td id="tq20" class="cell clean" onclick="prompt.show('q20', 300)">
							<h3>300</h3>
							<div class="hide">
								<div id="q20">Bram Stroker</div>
								<div id="aq20">Who was the original author of Dracula?</div>
							</div>
						</td>
						...
						<td id="tq21" class="cell clean" onclick="prompt.show('q21', 300)">
							<h3>300</h3>
							<div class="hide">
								<div id="q21">Salman Rushdie</div>
								<div id="aq21">Who wrote the controversial book "the Satanic Verses"?</div>
							</div>
						</td>
						...
						<td id="tq22" class="cell clean" onclick="prompt.show('q22', 300)">
							<h3>300</h3>
							<div class="hide">
								<div id="q22">45 Seconds</div>
								<div id="aq22">How long are professional Golf Tour players allotted per shot?</div>
							</div>
						</td>
						...
						<td id="tq23" class="cell clean" onclick="prompt.show('q23', 300)">
							<h3>300</h3>
							<div class="hide">
								<div id="q23">Titan</div>
								<div id="aq23">Name of saturn's largest moon?</div>
							</div>
						</td>
						...
						<td id="tq24" class="cell clean" onclick="prompt.show('q24', 300)">
							...
							<div class="hide">
								<div id="q24">Zero</div>
								<div id="aq24">Magnetism at the centre of a bar magnet is</div>
							</div>
						</td>
			...
			<tr>
						...
						<td id="tq30" class="cell clean" onclick="prompt.show('q30', 400)">
							<h3>400</h3>
							<div class="hide">
								<div id="q30">Verona</div>
								<div id="aq30">In which city did Romeo and Julia live?</div>
							</div>
						</td>
						...
						<td id="tq31" class="cell clean" onclick="prompt.show('q31', 400)">
							<h3>400</h3>
							<div class="hide">
								<div id="q31">Rabindranath Tagore</div>
								<div id="aq31">Who wrote the national anthem of bangladesh,"Amar Shonar Bangla"?</div>
							</div>
						</td>
						...
						<td id="tq32" class="cell clean" onclick="prompt.show('q32', 400)">
							...
							<div class="hide">
								<div id="q32">1946</div>
								<div id="aq32">When was Amateur Athletics Federation of India established?</div>
							</div>
						</td>
						...
						<td id="tq33" class="cell clean" onclick="prompt.show('q33', 400)">
							<h3>400</h3>
							<div class="hide">
								<div id="q33">Black Hole</div>
								<div id="aq33">Where, theoretically, might one find objects squeezed to an infinite density?</div>
							</div>
						</td>
						...
						<td id="tq34" class="cell clean" onclick="prompt.show('q34', 400)">
							<h3>400</h3>
							<div class="hide">
								<div id="q34">Intensity of illumination</div>
								<div id="aq34">Lux is the SI unit of</div>
							</div>
						</td>
			...
			<tr>
						...
						<td id="tq40" class="cell clean" onclick="prompt.show('q40', 500)">
							...
							<div class="hide">
								<div id="q40">25</div>
								<div id="aq40">What is the minimum age to contest Loksabha elections?</div>
							</div>
						</td>
						...
						<td id="tq41" class="cell clean" onclick="prompt.show('q41', 500)">
							<h3>500</h3>
							<div class="hide">
								<div id="q41">Jnanpith Award</div>
								<div id="aq41">The highest honour in Indian literature?</div>
							</div>
						</td>
						...
						<td id="tq42" class="cell clean" onclick="prompt.show('q42', 500)">
							<h3>500</h3>
							<div class="hide">
								<div id="q42">Reggie Miller</div>
								<div id="aq42">Which NBA player scored 8 points in the final 7 seconds of a game to lead his team to victory?</div>
							</div>
						</td>
						...
						<td id="tq43" class="cell clean" onclick="prompt.show('q43', 500)">
							<h3>500</h3>
							<div class="hide">
								<div id="q43">Hubble Telescope</div>
								<div id="aq43">What is the name of NASA’s most famous space telescope?</div>
							</div>
						</td>
						...
						<td id="tq44" class="cell clean" onclick="prompt.show('q44', 500)">
							<h3>500</h3>
							<div class="hide">
								<div id="q44">Henri Becquerel</div>
								<div id="aq44">Natural radioactivity was discovered by</div>
							</div>
						</td>
